...
def main():
    ...
    #Step 1 - Define directories; start with a gray image with a little noise
    data_dir = '../data/'
    output_dir = '../output/'
    model_fn = 'tensorflow_inception_graph.pb'
    file_name = 'School_of_ai.jpg'
    output_name = 'SOAI_dream'
    ...
    def render_deepdream(t_obj, img0=img_noise,
                         iter_n=10, step=1.5, octave_n=4, octave_scale=1.4, show_arr=True):
    ...
    #open image
    img0 = PIL.Image.open(data_dir + file_name)
    img0 = np.float32(img0)
     
    #Step 4 - Apply gradient ascent to that layer
    render_deepdream(tf.square(T('mixed4c')), img0, octave_n=10, show_arr=False)
